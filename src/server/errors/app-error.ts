...
export function mapDatabaseError(error: { message?: string; code?: string } | null): never {
  ...
  const known = ["PACKAGE_NOT_ELIGIBLE_FOR_CLOSING","CLOSING_NOT_DRAFT","CLOSING_HAS_PAYMENTS","SHIPMENT_NOT_DEPARTABLE","SHIPMENT_NOT_RECONCILABLE","MISSING_CONFIRMATION_REQUIRED","PAYMENT_EXCEEDS_BALANCE","PICKUP_PACKAGE_NOT_READY","PICKUP_EMPTY","PACKAGE_ATTACHMENT_LIMIT"];
